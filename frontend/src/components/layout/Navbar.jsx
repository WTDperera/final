        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <nav className="flex items-center gap-6">
              <a href="/dashboard" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors">
                Dashboard
              </a>
              <a href="/receipts" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors">
                Receipts
              </a>
              <a href="/analytics" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors">
                Analytics
              </a>
            </nav>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-3">
              <a href="/dashboard" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors px-4 py-2">
                Dashboard
              </a>
              <a href="/receipts" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors px-4 py-2">
                Receipts
              </a>
              <a href="/analytics" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 transition-colors px-4 py-2">
                Analytics
              </a>
