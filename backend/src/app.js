...
// Middleware
// Allow frontend dev origin by default; override via CORS_ORIGINS/ALLOWED_ORIGINS env (comma-separated)
const corsEnv = process.env.CORS_ORIGINS || process.env.ALLOWED_ORIGINS || 'http://localhost:5173';
